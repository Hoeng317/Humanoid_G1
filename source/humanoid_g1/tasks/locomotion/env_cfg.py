...
from humanoid_g1.assets.g1_asset import G1_29DOF_CFG as ROBOT_CFG
from humanoid_g1.assets.joint_contract import load_joint_contract
from humanoid_g1 import mdp

JOINT_NAMES = load_joint_contract().policy_names
...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "pyramid_slope": terrain_gen.HfPyramidSlopedTerrainCfg(
            proportion=0.25, slope_range=(0.0, 0.25), platform_width=3.0, border_width=0.25
        ),
    },
)
...
class TerminationsCfg:
    ...
    joint_position_invalid = DoneTerm(func=mdp.joint_pos_out_of_limit)
    joint_velocity_invalid = DoneTerm(func=mdp.joint_vel_out_of_limit)
...
class RobotFlatEnvCfg(RobotEnvCfg):
    """Flat-ground training environment; same policy/deployment contract."""
